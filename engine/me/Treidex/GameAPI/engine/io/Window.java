package me.Treidex.GameAPI.engine.io;
...
public class Window
{
	...
	public void update()
	{
		...
		GL11.glClearColor((float) Color.getRed(background) / 255, (float) Color.getGreen(background) / 255, (float) Color.getBlue(background) / 255, 1f);
